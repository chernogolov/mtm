...
class Resource extends Model
{
    ...
    protected $fillable = [
        'ordering', 'name', 'one_name', 'route_prefix', 'view_prefix', 'model_name', 'editable_fields', 'catalog_fields', 'fields', 'template', 'form_fields', 'api_fields','view_fields','export_fields'
    ];
